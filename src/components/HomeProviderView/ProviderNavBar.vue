    ...
    <div class="provider_navbar">
        <div class="items">
            ...
            <ul class="menu__box" id="menu__box">
                <li><router-link class="nav__link" to="/offers">Мои предложения</router-link></li>
                <li><router-link class="nav__link" to="/orders">Заказы</router-link></li>
